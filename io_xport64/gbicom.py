...
PRE_BUILT_SETTINGS = {
    ...
    "TEXTURE_4B" : {
        ...
        "SetGeometryModeVTXCOLOR" : "   %sSPSetGeometryMode( %s  G_ZBUFFER | G_SHADE | G_FOG | G_SHADING_SMOOTH | G_CULL_BACK  %s\n",
        "SetGeometryModeVTXLIGHT" : "   %sSPSetGeometryMode( %s  G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_CULL_BACK  %s\n",
...
#NOTE ----- TEXTURE_16B_RGBA_UNLIT - For use with "emissive" objects that are NOT shaded by "real time" or "baked" vertex color lighting
    ...
    "TEX_4B_CI_LIQUID" : {
        ...
        "SetGeometryModeVTXCOLOR" : "   %sSPSetGeometryMode( %s  G_ZBUFFER | G_SHADE | G_FOG | G_SHADING_SMOOTH  %s\n",
        "SetGeometryModeVTXLIGHT" : "   %sSPSetGeometryMode( %s  G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH  %s\n", 
        "Texture" : "   %sSPTexture(  %s 0xffff, 0xffff, 0, G_TX_RENDERTILE, G_ON  %s\n",        
        "TextureLUT" : "   %sDPSetTextureLUT(  %s G_TT_RGBA16 %s\n",
        "LoadTLUT" : "   %sDPLoadTLUT_pal16(  %s 0, %s %s\n",
        "SetCombineLERP" : "   %sDPSetCombineLERP(  %s	TEXEL0, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED %s\n",
    ...
    "TEX_4B_CI_LIGHTSHAFT" : {
        ...
        "SetGeometryModeVTXCOLOR" : "   %sSPSetGeometryMode( %s  G_ZBUFFER | G_SHADE | G_SHADING_SMOOTH  %s\n",
        "Texture" : "   %sSPTexture(  %s 0xffff, 0xffff, 0, G_TX_RENDERTILE, G_ON  %s\n",        
        "TextureLUT" : "   %sDPSetTextureLUT(  %s G_TT_RGBA16 %s\n",
        "LoadTLUT" : "   %sDPLoadTLUT_pal16(  %s 0, %s %s\n",
